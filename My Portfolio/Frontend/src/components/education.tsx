          ...
          {education.map((edu, index) => (
            <div key={index} className="relative education-card-container">
              ...
              <div className="relative education-card bg-gray-800 p-6 rounded-lg shadow-lg transform transition-transform hover:scale-105">
                <img src={edu.image} alt={edu.institution} className="w-full h-48 object-cover rounded-t-lg border-b-2 border-yellow-400" />
                <div className="p-4">
                  <h3 className="text-2xl font-bold text-yellow-400">{edu.institution}</h3>
                  <div className="text-yellow-400 flex items-center my-2">
