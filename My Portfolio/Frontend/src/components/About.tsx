        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="relative mb-8 md:mb-0 md:mr-8">
            ...
            <div className="relative bg-gray-800 rounded-lg shadow-lg p-6 md:p-12">
              <h1 className="text-3xl md:text-4xl font-bold mb-4 text-green-400 dark:text-yellow-400">AFRiTeQ_ORG</h1>
            </div>
          </div>
          {/* About Section */}
          <div className="bg-gray-800 rounded-lg shadow-lg p-6 md:p-12 w-full md:w-2/3">
            ...
            <a href="contact-Me" className="inline-block px-8 py-3 bg-blue-400 dark:bg-yellow-400 text-gray-900 font-semibold rounded-lg hover:bg-yellow-300 dark:hover:bg-green-400 transition duration-300">
              Hire Me
            </a>
          </div>
        </div>
